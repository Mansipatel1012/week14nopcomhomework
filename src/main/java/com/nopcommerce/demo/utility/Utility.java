...
public class Utility extends ManageBrowser {
    ...
    public void clickOnElement(WebElement element, String s) {
        element.click();
    }
...
//********* Action Methods *************//
    ...
    public void mouseHoverToElementAndClick2(WebElement element) {
        Actions actions = new Actions(driver);
        try {
            Thread.sleep(1000);
        } catch (InterruptedException e) {
    ...
    public boolean verifyText(WebElement element, By locator, String expectedText) {
        //  WebElement element = driver.findElement(locator);
